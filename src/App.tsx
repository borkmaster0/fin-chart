...
import { Sun, Moon, LineChart, Menu, X, RefreshCw, Plus, BarChart3, Briefcase, TrendingUp, ChartCandlestick } from 'lucide-react';
...
function App() {
  ...
  const navigationItems = [
    ...
    { id: 'compare', label: 'Compare', icon: ChartCandlestick }
  ];
